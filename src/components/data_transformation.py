...
class DataTransformationConfig:
    ...
    label_encoder_obj_file_path = os.path.join('artifacts', 'label_encoder.pkl')  # Save LabelEncoder for target
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ## Function responsible for transforming data
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Encoding target variable ('Drug')")
            ...
            logging.info("Saved preprocessing and label encoder objects!")
